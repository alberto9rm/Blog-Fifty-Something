    ...
    <div class="row">
        <div class="col-lg-8">
            ...
            <article>
                ...
                <?php 
                $id_post = $_GET['id']; // Asegúrate de que estás usando 'id' aquí si has cambiado 'idPost'
                $sql = "SELECT * FROM post WHERE id = '$id_post' "; // Cambia 'idPost' a 'id'
                ...
                on <?php echo $datos['date_time'] ?>
                    </div>

                <!-- Post categories-->
                <a class="badge bg-secondary text-decoration-none link-light mb-3" href="category.php?id=<?php echo $datos['category'] ?>"
                    style="font-size: 1rem; padding: 0.65rem 1rem;"><?php echo $datos['category'] ?></a>

                <!-- Post content-->
                <section class="mb-5">
                    <p class="fs-5 mb-4">
                    <?php echo ($datos['post']); ?><br></p>
                </section>
